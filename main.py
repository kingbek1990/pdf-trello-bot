...
def parse_zayavka(text: str) -> dict:
    ...
    # Mahsulotlar — detal raqami bor format
    mahsulotlar = []
...
def format_card_name(raqam, sana, bolim, tur, mahsulotlar):
    # Karta nomida faqat birinchi 2 ta mahsulot
...
def format_description(mahsulotlar):
    # Opisaniega barcha mahsulotlar ro'yxat sifatida
    if not mahsulotlar:
        return ""
